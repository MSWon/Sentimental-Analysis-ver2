...
if __name__ == '__main__':
    ...
    print('========================')
    ## Build model
    model = Model(FLAGS.batch_size, FLAGS.word_dim, FLAGS.hidden_dim, FLAGS.num_layers, FLAGS.max_vocab_size,
                  FLAGS.max_word_len, FLAGS.learning_rate, FLAGS.training_epochs, FLAGS.path, False)
